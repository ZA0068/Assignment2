...
config_export -format ip_catalog -output /home/gabris/Documents/KalmanFilterKernel.zip -rtl vhdl
#source "./KF_kernel/solution1/directives.tcl"
csim_design
csynth_design
cosim_design
export_design -rtl vhdl -format ip_catalog -output /home/gabris/Documents/KalmanFilterKernel.zip
