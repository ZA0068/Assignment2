; ModuleID = '/home/gabris/Documents/MPSoC4Drones/hls/KF_kernel/KF_kernel/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_KalmanFilterKernel_ir(float* %din, float* %dout, float %q, float %r) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_KalmanFilterKernel_hw(float* %2, float* %3, float %q, float %r)
...
declare void @apatb_KalmanFilterKernel_hw(float*, float*, float, float)

define void @KalmanFilterKernel_hw_stub_wrapper(float*, float*, float, float) #5 {
entry:
  %4 = bitcast float* %0 to [2048 x float]*
  %5 = bitcast float* %1 to [2048 x float]*
  call void @copy_out([2048 x float]* null, [2048 x float]* %4, [2048 x float]* null, [2048 x float]* %5)
  %6 = bitcast [2048 x float]* %4 to float*
  %7 = bitcast [2048 x float]* %5 to float*
  call void @KalmanFilterKernel_hw_stub(float* %6, float* %7, float %2, float %3)
  call void @copy_in([2048 x float]* null, [2048 x float]* %4, [2048 x float]* null, [2048 x float]* %5)
  ret void
}

declare void @KalmanFilterKernel_hw_stub(float*, float*, float, float)
