...
extern "C" void KalmanFilterKernel(int*, int*, float, float);
extern "C" void apatb_KalmanFilterKernel_hw(volatile void * __xlx_apatb_param_din, volatile void * __xlx_apatb_param_dout, float __xlx_apatb_param_q, float __xlx_apatb_param_r) {
  ...
  // DUT call
  KalmanFilterKernel(__xlx_din__input_buffer, __xlx_dout__input_buffer, __xlx_apatb_param_q, __xlx_apatb_param_r);
