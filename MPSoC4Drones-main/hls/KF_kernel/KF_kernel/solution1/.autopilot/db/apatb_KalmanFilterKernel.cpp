...
extern "C" void KalmanFilterKernel_hw_stub_wrapper(volatile void *, volatile void *, float, float);

extern "C" void apatb_KalmanFilterKernel_hw(volatile void * __xlx_apatb_param_din, volatile void * __xlx_apatb_param_dout, float __xlx_apatb_param_q, float __xlx_apatb_param_r) {
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > dout_pc_buffer(2048);
          int i = 0;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_din)[j];
  ...
  tcl_file.set_num(2048, &tcl_file.din_depth);
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_dout)[j];
  ...
  tcl_file.set_num(2048, &tcl_file.dout_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_dout, __xlx_sprintf_buffer.data());
}
...
KalmanFilterKernel_hw_stub_wrapper(__xlx_apatb_param_din, __xlx_apatb_param_dout, __xlx_apatb_param_q, __xlx_apatb_param_r);
