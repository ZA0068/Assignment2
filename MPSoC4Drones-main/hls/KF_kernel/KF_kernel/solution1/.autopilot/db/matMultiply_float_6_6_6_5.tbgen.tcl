set moduleName matMultiply_float_6_6_6_5
set isTopModule 0
...
set C_modelName {matMultiply<float, 6, 6, 6>.5}
set C_modelType { void 0 }
set C_modelArgList {
	{ mat_in_L float 32 regular {array 18 { 1 } 1 1 }  }
	{ mat_in_R float 32 regular {array 36 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ mat_in_R_address0 sc_out sc_lv 6 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mat_in_R_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "mat_in_R", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.facc_32ns_32ns_1ns_32_3_no_dsp_1_U28", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	mat_in_R { ap_memory {  { mat_in_R_address0 mem_address 1 6 }  { mat_in_R_ce0 mem_ce 1 1 }  { mat_in_R_q0 mem_dout 0 32 } } }
