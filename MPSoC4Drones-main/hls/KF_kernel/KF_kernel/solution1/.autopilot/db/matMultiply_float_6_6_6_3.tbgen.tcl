set moduleName matMultiply_float_6_6_6_3
set isTopModule 0
...
set C_modelName {matMultiply<float, 6, 6, 6>.3}
set C_modelType { void 0 }
set C_modelArgList {
	{ mat_in_L float 32 regular {array 36 { 1 3 } 1 1 }  }
	{ mat_in_R float 32 regular {array 9 { 1 3 } 1 1 }  }
	{ mat_out float 32 regular {array 18 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ mat_in_R_address0 sc_out sc_lv 4 signal 1 } 
	{ mat_in_R_ce0 sc_out sc_logic 1 signal 1 } 
	{ mat_in_R_q0 sc_in sc_lv 32 signal 1 } 
	{ mat_out_address0 sc_out sc_lv 5 signal 2 } 
	{ mat_out_ce0 sc_out sc_logic 1 signal 2 } 
	{ mat_out_we0 sc_out sc_logic 1 signal 2 } 
	{ mat_out_d0 sc_out sc_lv 32 signal 2 } 
	{ grp_fu_5987_p_din0 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_5987_p_din1 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_5987_p_dout0 sc_in sc_lv 32 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mat_in_R_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "mat_in_R", "role": "address0" }} , 
 	...
 	{ "name": "mat_out_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "mat_out", "role": "address0" }} , 
 	...
 	{ "name": "grp_fu_5987_p_din0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_5987_p_din0", "role": "default" }} , 
 	{ "name": "grp_fu_5987_p_din1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_5987_p_din1", "role": "default" }} , 
 	{ "name": "grp_fu_5987_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_5987_p_dout0", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.facc_32ns_32ns_1ns_32_3_no_dsp_1_U39", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	mat_in_R { ap_memory {  { mat_in_R_address0 mem_address 1 4 }  { mat_in_R_ce0 mem_ce 1 1 }  { mat_in_R_q0 mem_dout 0 32 } } }
	mat_out { ap_memory {  { mat_out_address0 mem_address 1 5 }  { mat_out_ce0 mem_ce 1 1 }  { mat_out_we0 mem_we 1 1 }  { mat_out_d0 mem_din 1 32 } } }
}
